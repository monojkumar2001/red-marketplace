        ...
        <div className="container-fluid p-0 m-0">
          <div className="user-admin-warrper">
           ...
           <Sidebar/>
            ...
            <div className="user-wallet-balance-item">
                <div className="row g-5">
                    <div className="col-lg-8 col-md-12">
                        <div className="balance-item-content">
                           ...
                           <div className="balance-imgs">
                           <img src="./assets/img/user-dashboard/balance-shit-2.png" alt="" />
                           </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-12">
                        <div className="balance-item-img">
                        <img src="./assets/img/user-dashboard/wallet-img.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
